    ...
    def export_json(self):
        ...
        export_general = {
            ...
            "BEA_parameters": {
                ...
                "BEA_step_threshold": self.BEA_step_thresh,
        ...
        export_backward_bifurcations = {
            "mother_IDs": self.backward_bifurcations.mother_IDs,
            "flags": self.backward_bifurcations.flags,
            "a1a2a3_coefficients": self.backward_bifurcations.a1a2a3_coefficients,
            "length_mismatch": self.backward_bifurcations.length_mismatch,
        }
