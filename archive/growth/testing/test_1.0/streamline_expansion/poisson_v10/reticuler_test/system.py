...
class Box:
    ...
    def __init__(
        ...
        self.seeds_connectivity = seeds_connectivity or []
...
class Network:
    ...
    def __init__(
        ...
        self.active_branches = active_branches or []  # moving branches (to extend)
        # branches without enough flux to move (may revive in the Poisson case)
        self.sleeping_branches = sleeping_branches or []

        self.branch_connectivity = branch_connectivity or []
...
class System:
    ...
    def __init__(
        ...
        self.growth_gauges = growth_gauges or np.zeros(4)
