...
growthThreshType=1 # 0: number of steps, 1: height, 2: network length, 3: evolution time
growthThresh=10 # Poisson: 13 for pictures, 9 for the BEA
...
for subexp in papers/2022SciRep/laplace_different_eta
do
	...
	wait_till 5 # ( ./growth_lap.sh > ~/reticuler/bash_scripts/out_lap.txt 2>&1 & )
	for iEta in 5 10 20 25 30 35 40 45 50 55 60
	do
		run_single_exp $iEta
	done
done
