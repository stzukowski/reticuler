...
growthThresh=2.5 # Poisson - for number of steps: around 2/ds for short tree and 3.5/ds for long tree, for network length: 12.832
...
for subexp in papers/2022SciRep/laplace
do
